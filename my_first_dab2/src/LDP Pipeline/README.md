...
This folder defines all source code for the 'LDP Pipeline' pipeline:
...
* Take a look at the sample under "sample_users_ldp_pipeline.py" to get familiar with the syntax.
