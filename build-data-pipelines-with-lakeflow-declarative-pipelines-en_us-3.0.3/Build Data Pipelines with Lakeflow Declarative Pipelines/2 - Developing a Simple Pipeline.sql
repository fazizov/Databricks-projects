...
-- MAGIC - Describe the SQL syntax used to create a Lakeflow Declarative Pipeline.
...
-- MAGIC - Create, execute and monitor a Lakeflow Declarative Pipeline.
...
-- MAGIC
-- MAGIC     - **Pipeline root folder**: Select the **2 - Developing a Simple DLT Pipeline Project** folder (`/Workspace/Shared/Course Publishing using Binder/build-data-pipelines-with-lakeflow-declarative-pipelines/labs/Source/en_us/notebooks/Build Data Pipelines with Lakeflow Declarative Pipelines/2 - Developing a Simple Pipeline Project`)
-- MAGIC
-- MAGIC     - **Source code paths**: Within the same root folder as above, select the **orders** folder (`/Workspace/Shared/Course Publishing using Binder/build-data-pipelines-with-lakeflow-declarative-pipelines/labs/Source/en_us/notebooks/Build Data Pipelines with Lakeflow Declarative Pipelines/2 - Developing a Simple Pipeline Project/orders`)
-- MAGIC
...
-- MAGIC
-- MAGIC    h. Click **Add**, This will create a pipeline and associate the correct files for this demonstration.
-- MAGIC
-- MAGIC **Example**
-- MAGIC
