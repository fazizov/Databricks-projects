...
# MAGIC - Create a Lakeflow Declarative Pipeline using the Workspace and the Pipeline UI.
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC    d. Scroll to the bottom and enable **Lakeflow Pipelines Editor** if it's not enabled.
# MAGIC
# MAGIC    ![Lakeflow Pipeline Editor](./Includes/images/lakeflow-pipeline-editor.png)
# MAGIC
# MAGIC    e. Also Enable Tabs for notebooks and files from the section above.
# MAGIC
# MAGIC    f. Refresh your browser page to enable the option you turned on.
