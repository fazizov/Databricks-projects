...
course_config = CourseConfig(course_code = "betsdlt",
                             course_name = "advanced-processing-of-customer-bets-with-dlt",
                             data_source_name = "advanced-processing-of-customer-bets-with-dlt",
                             data_source_version = "v01",
                             install_min_time = "1 min",
                             install_max_time = "5 min",
                             remote_files = remote_files,
                             supported_dbrs = ["15.4.x-scala2.12"],
