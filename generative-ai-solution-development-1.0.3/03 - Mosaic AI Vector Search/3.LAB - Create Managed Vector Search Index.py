...
# MAGIC
# MAGIC 1. Create a Vector Search index. Use these parameters; source column as `content` and `databricks-bge-large-en` as embedding model. Also, the sync process should be  `manually triggered`.
# MAGIC
